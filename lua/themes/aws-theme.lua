...
function M.load()
  ...
  hi("LspSignatureActiveParameter", { fg = palette.aws_orange, bold = true })
  hi("LspCodeLens", { fg = palette.comment })
  hi("LspInlayHint", { fg = palette.gray_dim, bg = palette.navy_light })
  ...
  -- Notify
  hi("NotifyERRORBorder", { fg = palette.error })
  hi("NotifyWARNBorder", { fg = palette.warning })
  hi("NotifyINFOBorder", { fg = palette.info })
  hi("NotifyDEBUGBorder", { fg = palette.gray })
  hi("NotifyTRACEBorder", { fg = palette.purple })
  ...
  hi("TroubleCount", { fg = palette.aws_orange, bold = true })
  hi("TroubleNormal", { fg = palette.fg, bg = palette.bg_float })
