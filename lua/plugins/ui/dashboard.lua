...

  {
    ...
    opts = function()
      ...
      dashboard.section.buttons.val = {
        dashboard.button("f", "󰠮  Find file", "<cmd> Snacks.picker.files() <cr>"),
        dashboard.button("n", "󱙲  New file", [[<cmd> ene <BAR> startinsert <cr>]]),
        dashboard.button("r", "󱋡  Recent files", [[<cmd> Snacks.picker.recent() <cr>]]),
        dashboard.button("g", "󱁐  Find text", [[<cmd> Snacks.picker.grep() <cr>]]),
        dashboard.button("c", "󱁊  Config", "<cmd> Snacks.picker.files({cwd = vim.fn.stdpath('config')}) <cr>"),
